"""20260426 head-to-head eval: v9-architecture MJ-only P1 vs MJ+data1-4 P2.
...
print("=== 20260426 Arm A (MJ-only, P1) ===")
a = eval_arm("20260426_phase1_mj_only_gated_cross_attn_film_v9_arch", P1_BEST)
print("=== 20260426 Arm B (MJ + data1-4 finetune, P2) ===")
b = eval_arm("20260426_phase2_mj_vr1_4_ft_gated_cross_attn_film_v9_arch_batch512", P2_BEST)

delta = b["agg_sr"] - a["agg_sr"]
print(f"\n=== 20260426 DATA1-4 ABLATION ===")
print(f"  Arm A (MJ-only):     {a['agg_sr']:.2f}%")
print(f"  Arm B (MJ + data1-4): {b['agg_sr']:.2f}%")
