"""Re-export v9 ACT-Chunk implementation for Scheme A checkpoints.

Training is launched through ../20260425_train_v9/train_act_chunk.py so the root
paths match the original v9 implementation. This wrapper lets validate_policy
find `ACTChunkGatedCrossAttnFiLM` when loading checkpoints saved under this
