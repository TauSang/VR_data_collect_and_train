...
def main():
    ...
    if args.pretrained:
        ...
        if pretrained_path.exists():
            print(f"[ACT-Chunk] Loading pretrained: {pretrained_path}")
            ...
            # Optionally load normalizer from pretrained
            if "normalizer" in ckpt:
                print(f"[ACT-Chunk] Note: Using fresh normalizer from current data")
        else:
            print(f"[WARN] Pretrained not found: {pretrained_path}")
