"""Head-to-head MuJoCo eval: MJ-only vs MJ+VR finetune.

Phase 1 = MJ-only baseline (Arm A)
Phase 2 = MJ pretrain + VR finetune (Arm B)

Reports 5 seeds x 50 targets = 250 targets per arm.
"""
...
P1_BEST = ROOT / "20260424_train_v2/outputs/act_chunk/phase1_run_20260424_134942/checkpoints/best.pt"
P2_BEST = ROOT / "20260424_train_v2/outputs/act_chunk/phase2_run_20260424_140838/checkpoints/best.pt"
...
print("=== Arm A (MJ-only) ===")
a = eval_arm("phase1_mj_only", P1_BEST)
print("=== Arm B (MJ + VR finetune) ===")
b = eval_arm("phase2_mj_vr_ft", P2_BEST)
