"""v9 head-to-head eval: Gated-CrossAttn-FiLM v2-recipe MJ-only P1 vs MJ+VR1-3 P2.
...
TRAIN_DIR = ROOT / "20260425_train_v9"
...
print("=== v9 Arm A (MJ-only, P1) ===")
a = eval_arm("v9_phase1_mj_only_gated_cross_attn_film_v2recipe", P1_BEST)
print("=== v9 Arm B (MJ + VR1-3 finetune, P2) ===")
b = eval_arm("v9_phase2_mj_vr_ft_gated_cross_attn_film_v2recipe", P2_BEST)

delta = b["agg_sr"] - a["agg_sr"]
print(f"\n=== v9 ABLATION ===")
print(f"  Arm A (MJ-only):     {a['agg_sr']:.2f}%")
print(f"  Arm B (MJ + VR1-3):  {b['agg_sr']:.2f}%")
