...
class TaskACTEncoder(nn.Module):
    """Improved ACT with deeper transformer, residual action prediction, and multi-scale readout."""
    ...
    def __init__(
        ...
        # Multi-scale readout: use last token + mean pooling of all tokens
        ...
        if use_residual_action:
            # Residual action: predict delta from last observed action
            # obs contains joint positions at indices 0:act_dim
