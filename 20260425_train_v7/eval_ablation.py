"""v7 head-to-head eval: Transformer-Lite MJ-only P1 vs MJ+VR1-4 P2.
...
TRAIN_DIR = ROOT / "20260425_train_v7"
...
print("=== v7 Arm A (MJ-only, P1) ===")
a = eval_arm("v7_phase1_mj_only_transformer_lite", P1_BEST)
print("=== v7 Arm B (MJ + VR1-4 finetune, P2) ===")
b = eval_arm("v7_phase2_mj_vr_ft_transformer_lite", P2_BEST)
